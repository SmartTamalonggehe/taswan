            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="hak" class="col-md-4 col-form-label text-md-right">{{ __('Hak') }}</label>

                            <div class="col-md-6">
                                <select name="hak" id="hak" type="hak" class="form-control @error('hak') is-invalid @enderror" name="hak">
