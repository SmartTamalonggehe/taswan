...
<div class="app-main__inner">
    ...
    <div class="row">
        <div class="col-lg-12">
            <a href="{{ route('siswa.create') }}"class="mb-2 mr-2 btn-transition btn btn-outline-secondary">Tambah Data @yield('judul')</a>
                            ...
                            <td>
                                <div class="text-left">
                                    <div role="group" class="btn-group-sm btn-group btn-group-toggle" data-toggle="buttons">
                                        <button id="edit" href="siswa/{{ $item->id }}/edit" type="button" class="btn btn-alternate">Edit
                                        </button>
                                        <button id="delete" href="siswa/{{ $item->id }}" class="btn btn-danger">Hapus</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
