        ...
        <div class="col-lg-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <form action="{{ route('kelas.store') }}" class="needs-validation" novalidate method="POST">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="jmlh_kursi" name="jmlh_kursi" value="{{ old('jmlh_kursi') }}" required>
                                <div class="invalid-tooltip">
                                    Tidak Boleh Kosong
                                </div>
                            </div>
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="jmlh_meja" name="jmlh_meja" value="{{ old('jmlh_meja') }}" required>
                                <div class="invalid-tooltip">
                                    Tidak Boleh Kosong
                                </div>
                            </div>
