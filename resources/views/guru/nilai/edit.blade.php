        ...
        <div class="col-lg-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <form action="{{ route('nilai.update',$nilai) }}" class="needs-validation" novalidate method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                                ...
                                <select type="select" name="kd_pelajaran" id="kd_pelajaran" name="customSelect" class="custom-select" required>
                                    ...
                                    <option value="{{ old('kd_pelajaran') ?? $item->kd_pelajaran }}" @if ($item->kd_pelajaran==$nilai->kd_pelajaran) selected @endif>{{ $item->nm_pelajaran }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <select type="select" name="NIS" id="NIS" name="customSelect" class="custom-select" required>
                                    ...
                                    <option value="{{ old('NIS') ?? $item->NIS }}" @if ($item->NIS==$nilai->NIS) selected @endif>{{ $item->NIS }} | {{ $item->nm_siswa }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-tooltip">
                                    Tidak Boleh Kosong
                            ...
                            <div class="col-md-1 mb-3">
                                ...
                                <input type="text" class="form-control" id="nilai" name="nilai" value="{{ old('nilai') ?? $nilai->nilai}}" required>
                                <div class="invalid-tooltip">
                                    Tidak Boleh Kosong
                                </div>
                            </div>
                            <div class="col-md-2 mb-3">
                                ...
                                <select type="select" name="thn" id="thn" name="customSelect" class="custom-select" required>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <option value="<?php echo $x ?>" @if ($nilai->thn==$x) selected @endif><?php echo $x ?></option>
                                    <?php } ?>
                                </select>
                                <div class="invalid-tooltip">
                                    Tidak Boleh Kosong
